...
HD_PWD='/home/it/project_lab3/project_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sev_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sev_seg.tcl
