...
HD_PWD='/home/it/project_lab3/project_lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sev_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sev_seg.tcl -notrace
